...
/** The book type */
export type Book = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Book';
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
...
/** Group within the flex field */
export type Page_Pagesections_PageSections_CharacterArt = AcfFieldGroup & {
  __typename?: 'Page_Pagesections_PageSections_CharacterArt';
  art?: Maybe<Array<Maybe<Page_Pagesections_PageSections_CharacterArt_Art>>>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  preTitle?: Maybe<Scalars['String']>;
};

export type Page_Pagesections_PageSections_CharacterArt_Art = Art;
...
export type RootQueryToBookConnectionWhereArgsTaxArray = {
...
/** Query objects based on taxonomy parameters */
export type RootQueryToBookConnectionWhereArgsTaxQuery = {
  relation?: InputMaybe<RelationEnum>;
